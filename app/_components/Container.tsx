...
const defaultStyles: Record<ContainerStyles, string> = {
  primary:
    "flex flex-wrap p-1 rounded-md bg-light-container dark:bg-dark-container primaryTransition",
  secondary:
    "flex flex-col px-3 py-2 rounded-md bg-light-container dark:bg-dark-container primaryTransition",
